      ...
      <div className="formitem-subscription">
        ...
        <SelectMenu className="formitem-dropdown">
          ...
          }
          {
            !showSubscriptionFilter &&
            <SelectMenu.Modal width="370px">
              <SelectMenu.Filter padding="0" width="355px" onChange={(event: any) => { this.onFilteringSubscription(event.target.value) }} placeholder={Constants.DropdownFilterAriaLabel} value={this.state.subscriptionParameters.searchValueForSubscriptions} aria-label={Constants.DropdownFilterAriaLabel} />
              <SelectMenu.List>
              </SelectMenu.List>
            </SelectMenu.Modal>
          }
